...
if data.multiStart
    ...
    options=optimset('Algorithm', 'sqp', 'Display','final');%rasmus 26.07 %options = optimoptions('fmincon','Algorithm','interior-point');

    [params] = fmincon(@circLinPredMod, startPoint, [], [], [], [], lb, ub, [], options);
